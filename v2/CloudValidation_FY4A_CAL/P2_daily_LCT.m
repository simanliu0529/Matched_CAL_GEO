...
Outpath0 = '/PublicData/CAL_FY4_MatchData/FY4A/Matched_P2_LCT/';
...
for i=2
    ...
    for fileFY4_i = 1:254
        ...
        %% 加载地表类型
        LCT = importdata(['/PublicData/LCTsandNISE2022/Combined_LCT/',NameTimeStr,'_Combined_LCT','.mat']);
        landtype = LCT.Data; % 和H8数据一样的结构
        ...
        save([Outpath,'Mated_LandTypeTable_',Time_Current,'.mat'],'Mated_CloudTable','-v7.3');
