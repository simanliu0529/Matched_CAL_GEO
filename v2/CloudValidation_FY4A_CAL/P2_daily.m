...
dirFY4 = 'J:\实验数据\FY4Data\FY4A\'; %加载葵花数据
dirMatch = 'J:\实验数据\Matched_P1_New\FY4A\';
Outpath0 = 'J:\实验数据\Matched_P2_New\FY4A\';
...
for i=1:2
    ...
    for fileFY4_i = 1:fileNum_FY4
        ...
        LatLon = importdata('J:\实验数据\FY4A-LatrLon.mat');
        FY4_Lon = LatLon.Lon;
        FY4_Lat = LatLon.Lat;
        ...
        MatchedTable = [FY4_Lat2(Index),FY4_Lon2(Index),FY4_SOZ_All(Index),...
            FY4_Cloud_All(Index),FY4_CLP_All(Index),FY4_CTH_All(Index),... %FY4A_FullCloud_All(Index)
            CloudTop_CAL_95P(Index),CloudTop_CAL_COD(Index),...
            CloudFraction_CAL(Index),CloudFraction_CAL_COD(Index),...
            CloudPhase_CAL(Index),CloudPhase_CAL_COD(Index),...
            MultiFraction_CAL(Index),MultiFraction_CAL_COD(Index)];  % MultiFraction_CAL(Index),MultiFraction_CAL_COD(Index)
        ...
        MatchedTableVar = ['FY4A_Lat','FY4A_Lon','FY4A_SOZ',...
            'FY4A_CloudMask','FY4A_CloudPhase','FY4A_CloudTopHeight',...
            'CAL_CloudTop_95P','CAL_CloudTop_COD',...
            'CAL_CloudFraction','CAL_CloudFraction_COD',...
            'CAL_CloudPhase','CAL_CloudPhase_COD',...
            'CAL_MultiFraction','CAL_MultiFraction_COD'];
